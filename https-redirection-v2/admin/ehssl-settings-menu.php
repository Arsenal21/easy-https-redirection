                        ...
                        <div style="position: relative">
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <label><input type="checkbox" name="httpsrdrctn_force_resources" value="1" <?php if (isset($httpsrdrctn_options['force_resources']) && $httpsrdrctn_options['force_resources'] == '1') {
